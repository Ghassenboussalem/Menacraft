...
const AGENT_WEIGHTS = {
  'Image Forensics':         0.20,   // MobileViT + Groq multi-stage vision — strongest signal
  'Reverse Image Search':    0.18,   // TinEye temporal provenance — near-conclusive when found
  'OCR + Claim Checker':     0.15,   // Vision-based claim verification
  'Caption–Image Alignment': 0.12,   // Visual-semantic alignment
  'Text Content Analyzer':   0.10,   // OCR + AI text detection
  'Bot Pattern Detector':    0.10,   // Account-level context
  'Source Credibility':      0.08,   // Text-only heuristic
  'Link Scanner':            0.07,   // Often no links to analyze
};
...
module.exports = { verifyPost, verifyPostReal, runAgentsSse };
